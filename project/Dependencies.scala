...
object Dependencies {
  ...
  lazy val preservicaClientFs2 = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.7-SNAPSHOT"
  ...
  lazy val sqsClient = "uk.gov.nationalarchives" %% "da-s3-client" % "0.1.14-SNAPSHOT"
}
